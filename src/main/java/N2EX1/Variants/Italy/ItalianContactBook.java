...
public class ItalianContactBook implements ContactBook {

    public Address createAddress(String street, int streetNumber, String city, String postalCode) {
        return new ItalianAddress(street, streetNumber, city, postalCode);
    }

    public PhoneNumber createPhoneNumber(String phoneNumber) {
        return new ItalianPhoneNumber(phoneNumber);
    }
